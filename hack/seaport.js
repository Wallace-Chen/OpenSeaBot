...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.fulfillOrder = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress, recipientAddress = _b.recipientAddress, referrerAddress = _b.referrerAddress, _c = _b.gasFee, gasFee = _c === void 0 ? new bignumber_js_1.BigNumber(0) : _c, _d = _b.priorityFee, priorityFee = _d === void 0 ? new bignumber_js_1.BigNumber(0) : _d;
...
//                            }); })];
    ...
    OpenSeaPort.prototype._atomicMatch = function (_b) {
        var buy = _b.buy, sell = _b.sell, accountAddress = _b.accountAddress, _c = _b.metadata, metadata = _c === void 0 ? constants_1.NULL_BLOCK_HASH : _c, _d = _b.gasFee, gasFee = _d === void 0 ? new bignumber_js_1.BigNumber(0) : _d, _e = _b.priorityFee, priorityFee = _e === void 0 ? new bignumber_js_1.BigNumber(0) : _e;
//        var buy = _b.buy, sell = _b.sell, accountAddress = _b.accountAddress, _c = _b.metadata, metadata = _c === void 0 ? constants_1.NULL_BLOCK_HASH : _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 6: 
                        return [4];
                        //return [4 /*yield*/, this._validateMatch({
                        //    buy: buy,
                        //    sell: sell,
                        //    accountAddress: accountAddress,
